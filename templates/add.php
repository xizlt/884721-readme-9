        ...
        <div class="adding-post container">
            <div class="adding-post__tabs-wrapper tabs">
                <div class="adding-post__tabs filters">
                    <ul class="adding-post__tabs-list filters__list tabs__list">
                        ...
                        <li class="adding-post__tabs-item filters__item">
                            <a class="adding-post__tabs-link filters__button filters__button--photo <?php if ($tab === 'photo'): ?> filters__button--active tabs__item tabs__item--active <?php endif; ?>button"
                        ...
                        <li class="adding-post__tabs-item filters__item">
                            <a class="adding-post__tabs-link filters__button filters__button--video tabs__item button <?php if ($tab === 'video'): ?> filters__button--active tabs__item tabs__item--active <?php endif; ?> button"
                        ...
                        <li class="adding-post__tabs-item filters__item">
                            <a class="adding-post__tabs-link filters__button filters__button--text tabs__item <?php if ($tab === 'text'): ?> filters__button--active tabs__item tabs__item--active <?php endif; ?> button"
                        ...
                        <li class="adding-post__tabs-item filters__item">
                            <a class="adding-post__tabs-link filters__button filters__button--quote tabs__item <?php if ($tab === 'quote'): ?> filters__button--active tabs__item tabs__item--active <?php endif; ?> button"
                        ...
                        <li class="adding-post__tabs-item filters__item">
                            <a class="adding-post__tabs-link filters__button filters__button--link tabs__item <?php if ($tab === 'link'): ?>filters__button--active tabs__item tabs__item--active <?php endif; ?>button"
                               href="add.php?tab=link">
                ...
                <div class="adding-post__tab-content">
                    ...
                    <section
                            class="adding-post__photo tabs__content <?php if ($tab === 'photo'): ?> tabs__content--active<?php endif; ?>">
                        <h2 class="visually-hidden">Форма добавления фото</h2>
                        <form class="adding-post__form form" action="/add.php?tab=photo" method="post"
                                    ...
                                    <div class="adding-post__input-wrapper form__input-wrapper">
                                        ...
                                        <div class="form__input-section <?= isset($errors['link']) ? 'form__input-section--error' : ' ' ?>">
                                            <input class="adding-post__input form__input " id="photo-url" type="text"
                                                   name="link" placeholder="Введите ссылку"
                                                   value="<?= isset($post_data['link']) ? $post_data['link'] : '' ?>">
                    ...
                    <section
                            class="adding-post__video tabs__content <?php if ($tab === 'video'): ?> tabs__content--active<?php endif; ?>">
                        <h2 class="visually-hidden">Форма добавления видео</h2>
                        <form class="adding-post__form form" action="/add.php?tab=video" method="post"
                              enctype="multipart/form-data">
                            <div class="form__text-inputs-wrapper">
                                <div class="form__text-inputs">
                                    <?= $title_post; ?>
                    ...
                    <section
                            class="adding-post__text tabs__content <?php if ($tab === 'text'): ?> tabs__content--active<?php endif; ?>">
                                    ...
                                    <div class="adding-post__textarea-wrapper form__textarea-wrapper">
                                        ...
                                        <div class="form__input-section <?= isset($errors['message']) ? 'form__input-section--error' : ' ' ?>">
                                            <textarea class="adding-post__textarea form__textarea form__input"
                                                      id="post-text" name="message"
                                                      placeholder="Введите текст публикации"><?= isset($post_data['message']) ? $post_data['message'] : '' ?></textarea>
                                            <button class="form__error-button button" type="button">!<span
                                                        class="visually-hidden">Информация об ошибке</span></button>
                                            <div class="form__error-text">
                    ...
                    <section
                            class="adding-post__quote tabs__content <?php if ($tab === 'quote'): ?> tabs__content--active<?php endif; ?>">
                                    ...
                                    <div class="adding-post__input-wrapper form__textarea-wrapper">
                                        ...
                                        <div class="form__input-section <?= isset($errors['message']) ? 'form__input-section--error' : ' ' ?>">
                                            <textarea
                                                    ...
                                                    id="cite-text" name="message"
                                                    placeholder="Текст цитаты"><?= isset($post_data['message']) ? $post_data['message'] : '' ?></textarea>
                                            <button class="form__error-button button" type="button">!<span
                                                        class="visually-hidden">Информация об ошибке</span></button>
                                            <div class="form__error-text">
                                                <h3 class="form__error-title"><?= $errors['message']['for_title']; ?></h3>
                                    ...
                                    <div class="adding-post__textarea-wrapper form__input-wrapper">
                                        ...
                                        <div class="form__input-section <?= isset($errors['quote']) ? 'form__input-section--error' : ' ' ?>">
                                            <input class="adding-post__input form__input" id="quote-author" type="text"
                                                   name="quote"
                                                   value="<?= isset($post_data['quote']) ? $post_data['quote'] : '' ?>">
                                            <button class="form__error-button button" type="button">!<span
                                                        class="visually-hidden">Информация об ошибке</span></button>
                                            <div class="form__error-text">
                    ...
                    <section
                            class="adding-post__link tabs__content <?php if ($tab === 'link'): ?> tabs__content--active<?php endif; ?>">
                        ...
                        <form class="adding-post__form form" action="/add.php?tab=link" method="post">
                            <div class="form__text-inputs-wrapper">
                                <div class="form__text-inputs ">
                                    ...
                                    <div class="adding-post__textarea-wrapper form__textarea-wrapper">
                                        <label class="adding-post__label form__label" for="post-text">Описание
                                            ссылки</label>
                                        <div class="form__input-section <?= isset($errors['message']) ? 'form__input-section--error' : ' ' ?>">
                                            <textarea class="adding-post__textarea form__textarea form__input"
                                                      id="post-text" placeholder="Введите текст публикации"
                                                      value="<?= isset($post_data['message']) ? $post_data['message'] : '' ?>"
